...
export default function Cadastro( {navigation, route}) {
    ...
    return (
      ...
      <FontAwesome.Button onPress={()=>navigation.navigate('Cadastro_usuario', {tipo_negocio:'Imovel'}) } style={styles.button_branco_300}name="home"  size={22}  >
      <Text  style={styles.font_branca} >Imoveis </Text>
      </FontAwesome.Button>
